...
const PrincipalVariationTable: React.FC<PrincipalVariationTableProps> = ({
    ...
    // --- LOGGING ---
    console.log(`[PVTable] Rendering with pvDisplayLength: ${pvDisplayLength}, pvString: "${pvString}"`);
    // --- END LOGGING ---
    ...
    // --- LOGGING ---
    console.log(`[PVTable] All moves from pvString (length ${allMoves.length}):`, allMoves);
    // --- END LOGGING ---

    const movesToDisplay = allMoves.slice(0, pvDisplayLength);
    // --- LOGGING ---
    console.log(`[PVTable] Moves to display after slicing with pvDisplayLength ${pvDisplayLength} (length ${movesToDisplay.length}):`, movesToDisplay);
    // --- END LOGGING ---
